...
const Dashboard = () => {
  ...
  const { statistics, recentTasks, charts, fetchDashboardData, isLoading } =
    useDashboardStore();
  ...
  return (
    <SidebarLayout>
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        {/* LOADER ONLY FOR DASHBOARD CONTENT */}
        {isLoading ? (
          ...
          <>
            ...
            <div className="bg-base-100 border border-gray-200 shadow-sm rounded-xl p-6 flex flex-col gap-4">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-base-200 p-4 rounded-xl shadow-sm">
                  <h2 className="text-lg font-bold mb-2">Tasks by Status</h2>
                  <TaskPieChart data={charts.taskDistribution} />
                </div>

                <div className="bg-base-200 p-4 rounded-xl shadow-sm">
                  <h2 className="text-lg font-bold mb-2">Tasks by Priority</h2>
            ...
            <div className="bg-base-100 border border-gray-200 shadow-sm rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Link to="/admin/tasks" className="btn btn-sm btn-primary">
                  See All
                </Link>
              </div>
